...
Workspace package names: `@exp/web`, `@exp/push-relay`, `@exp/steer-relay`, `@exp/marketing`, `@exp/db-schema`, `@exp/design-tokens`, `@exp/domain-contract`, `@exp/icons`, `@exp/electric-protocol`, `@exp/steer-ticket`, `@exp/widget`, `@exp/tsconfig`. (The desktop app `apps/desktop` is a Rust Cargo workspace, not a bun workspace.)
