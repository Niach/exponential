...
`db/out/custom/0001_triggers.sql` = 16 commented functions (identifiers, `updated_at`, denormalized scoping + board-hide mirrors, trash/archive fan-outs, builtin statuses, `status_id` from the anchor, membership mirrors, immutable `creem_subscription_id`).
