...
BUN_CONFIG_MAX_HTTP_REQUESTS  # Bun RUNTIME cap on simultaneous outbound fetches (default 256; read by Bun at process start, not app code). Baked as 65336 into the web Docker image — 15 Electric long-poll proxies per synced client saturate the default at ~17 clients and stall ALL other outbound fetches (REV2-6)
