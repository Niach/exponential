...
- `populate_issue_label_workspace_id()` / `populate_issue_child_workspace_id()` — denormalize `workspace_id` onto issue_labels / issue_subscribers / issue_events / coding_sessions so member shape filters stay workspace-scoped
