...
// backdrop blur. Everything a floating piece owns on its own (its size, its
// radius, its text colour, its layout) stays at the call site, because a 52px
// circle, a capsule and a rounded tray genuinely differ.
//
