...
| Marketing | `exponential.at` | `bh4vnu32zwiu0bw6nf8d7yt8` | public-source clone; build `cd apps/marketing && bun run build`, start `npx -y serve apps/marketing/dist -l 80` |
