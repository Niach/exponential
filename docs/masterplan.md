...
| L20 | **Tiers**: Free — 1 seat, unlimited projects/repos/coding sessions, 250 MB attachment storage/workspace, no widget. Pro — **$5/seat/mo billed yearly only** ($60/seat/yr), 2 GB/ws, 1 widget config. Business — **$10/seat/mo, monthly or yearly**, 10 GB/ws, unlimited widgets, priority support, SSO line-item. | |
...
| Attachment storage per workspace | 250 MB | 2 GB | 10 GB |
