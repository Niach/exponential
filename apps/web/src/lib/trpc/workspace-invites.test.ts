...
import { inviteListSelection } from "@/lib/trpc/workspace-invites"

// REV-4: workspaceInvites.list is member-visible (and relayed verbatim by the
...
describe(`workspaceInvites.list selection contract`, () => {
