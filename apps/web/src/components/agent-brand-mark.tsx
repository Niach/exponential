...
// `Assets.xcassets/agent-{claude,codex}`), copied here verbatim as inline
// paths because the web app ships no brand assets of its own. Brand marks are
// deliberately NOT part of the Lucide concept registry (they are not glyphs
// we may restyle); every OTHER glyph on this surface is a concept, and an
// agent this build does not know falls back to the `settings-agents` concept
// exactly like the desktop does.
const SettingsAgentsIcon = conceptIcon(`settings-agents`)

/** Claude's sunburst. Its own brand orange, never the text colour. */
const CLAUDE_FILL = `hsl(14.8, 63.1%, 59.6%)`
