...
// EXP-702: steer-image upload — every steered image, issue runs included,
// so steering screenshots stay out of the issue's Files section. Images
// only, session owner only. One multipart part named "file", same response
// contract as the issue `/files` route.
