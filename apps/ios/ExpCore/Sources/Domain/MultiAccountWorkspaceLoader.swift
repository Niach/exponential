...
public struct ServerWorkspaceGroup: Identifiable, Sendable {
    ...
    public let workspaces: [WorkspaceEntity]

    public init(accountId: String, hostname: String, userEmail: String?, workspaces: [WorkspaceEntity]) {
...
@Observable
public final class MultiAccountWorkspaceLoader: @unchecked Sendable {
    ...
    public var groups: [ServerWorkspaceGroup] {
