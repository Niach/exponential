...
public enum DomainContract {
    ...
    public static let issueEventTypeValues: [String] = ["status_changed", "assignee_changed", "label_added", "label_removed", "pr_opened", "pr_merged", "release_added", "release_removed", "project_moved"]
