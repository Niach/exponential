        ...
        <DocsLayout sections={SECTIONS} currentPath="/docs/actions/">
          ...
          <DocsSection id="what" num="01" label="What an action is">
            ...
            <p>
              ...
              an action starts from a saved instruction — so the work that
              isn&apos;t issue-shaped gets a home too: ship a release, run a
          ...
          <DocsSection id="running" num="04" label="Running one">
            ...
            <p>
              ...
              an <strong>Actions</strong> tab — same agent, model and effort
              pickers as an issue run.
            </p>
            <p>
