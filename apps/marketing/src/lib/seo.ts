...
export const PAGES: PageSeo[] = [
  ...
  },
  {
    ...
    description: `Free for teams of three. One Team plan at €12/seat/mo billed yearly (€15 monthly) with everything included. Local AI agents free on every plan. Self-host free for everyone, open source under Apache-2.0.`,
  ...
  },
  {
    ...
    description: `From zero to a working tracker: sign up, create your first board, connect GitHub, invite your team, and pick a plan.`,
    ogImage: `/og/og-docs.png`,
    jsonLd: breadcrumb([
      { name: `Home`, path: `/` },
      { name: `Docs`, path: `/docs/` },
  ...
  },
  {
    ...
    jsonLd: breadcrumb([
      { name: `Home`, path: `/` },
      { name: `Docs`, path: `/docs/` },
      { name: `Coding agents`, path: `/docs/coding/` },
    ]),
  },
  {
    path: `/docs/actions/`,
    htmlFile: `docs/actions/index.html`,
    sources: [`src/ActionsDocsPage.tsx`],
    title: `Actions · Exponential docs`,
    description: `Reusable team prompts your agents run on demand: authoring, typed inputs, the two builtins, and running one from the desktop, the web, or your phone.`,
    ogImage: `/og/og-docs.png`,
    jsonLd: breadcrumb([
      { name: `Home`, path: `/` },
      { name: `Docs`, path: `/docs/` },
      { name: `Actions`, path: `/docs/actions/` },
    ]),
  },
  {
    path: `/docs/cli/`,
