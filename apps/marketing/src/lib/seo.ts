...
export const PAGES: PageSeo[] = [
  {
    ...
    description: `Issues, customer support and coding agents in one realtime workspace. Agents run locally — unlimited sessions, flat price. Native on web, iOS, Android, macOS, Windows and Linux. Free for teams of three, open source and free to self-host.`,
