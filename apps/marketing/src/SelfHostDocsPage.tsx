...
Fetch https://raw.githubusercontent.com/Niach/exponential/master/INSTALL.md and follow it end-to-end: download the two selfhost files, fill in .env, bring the stack up with Docker Compose, and verify /api/health responds. Ask me for the decisions the runbook marks [decision] instead of guessing: which S3-compatible storage to use (and its credentials), and whether to go live on a domain.`
        ...
        <DocsLayout sections={SECTIONS} currentPath="/docs/self-host/">
          ...
          <DocsSection id="installation" num="01" label="Installation">
            ...
            <p>
              ...
              billing is disabled entirely. It&apos;s free for any team size,
              open source under Apache-2.0 (see{` `}
...
`}</DocsCode>
          ...
          <DocsSection id="github-app" num="03" label="GitHub App">
            ...
            <p>
              Repository permissions: set <strong>Contents</strong> and{" "}
              <strong>Pull requests</strong> to{` `}
              <strong>Read &amp; write</strong> (Metadata gets Read
...
`}</DocsCode>
          ...
          <DocsSection id="push" num="04" label="Push notifications">
            ...
            <p>
              ...
              Build the relay from a checkout too, since its image isn&apos;t
              published, precisely because this path is the exception:
            </p>
            <DocsCode language="shell">{`
          ...
          <DocsSection id="environment" num="07" label="Environment variables">
            ...
            <dl className="docs-env-list">
              ...
              <EnvVar name="S3_ENDPOINT" required>
                S3-compatible storage URL. Any provider works, see{` `}
              ...
              <EnvVar name="APP_URL">
                ...
                <code>https://issues.yourcompany.com</code>), which becomes{` `}
