// surfaces/dialogs.tsx — DialogScrim + the "Start coding" dialog primitives.
// Measured against the real desktop launcher:
...
// The dialog is an absolutely-positioned window-local box centered in the
...
export const SelectBox: React.FC<{
  ...
  value: string
  disabled?: boolean
  flickAt?: number // brief glow + value flick (staggered select cascade)
