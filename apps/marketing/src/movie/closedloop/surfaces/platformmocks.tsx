...
// (EXP-385): the web app inside a browser window, the MacBook bezel (its
// screen is a frozen live IDE composition passed in by the segment) and the
// mobile app inside an iPhone, plus the per-client platform icon rows
// (marketing DownloadSection.tsx twins). Recovered from the EXP-337-retired
...
// ── The phone (real mobile UI: team switcher header, filter chips, card rows,
...
export const PhoneMock: React.FC = () => (
  ...
  >
    <div style={{ position: "relative", width: PHONE.screenW, height: PHONE.screenH, borderRadius: 36, overflow: "hidden", backgroundColor: C.canvas }}>
      {/* status row */}
      ...
      <div style={{ position: "absolute", top: 88, left: 14, right: 14, display: "flex", alignItems: "center", gap: 7 }}>
        <span style={{ width: 28, height: 28, borderRadius: 999, backgroundColor: C.fillActive, color: C.muted, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Glyph size={13} sw={2}>
            <path d="M4 6h16" />
            <path d="M7 12h10" />
            <path d="M10 18h4" />
        ...
        {[
          ...
          <span
            ...
            style={{
              ...
              padding: "0 13px",
              borderRadius: 999,
              backgroundColor: active ? C.primary : C.fillActive,
      ...
      >
        <span style={{ width: 34, height: 34, borderRadius: 999, backgroundColor: C.fillActive, color: C.text, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Glyph size={15} sw={2}>
            <path d="M8 6h13" />
            <path d="M8 12h13" />
            <path d="M8 18h13" />
