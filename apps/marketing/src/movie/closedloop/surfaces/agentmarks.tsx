// closedloop/surfaces/agentmarks.tsx — the three agent brand marks (desktop
// assets/icons/{claude,codex,pi}.svg twins), shared by the phone start sheet.
...
export const PiMark: React.FC<{ size: number }> = ({ size }) => (
