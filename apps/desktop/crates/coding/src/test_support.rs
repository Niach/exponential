...
//! the canned response bodies both the issue and release prepare paths
...
pub(crate) const START_RELEASE_OK: &str = r#"{"result":{"data":{"session":{"id":"sess-rel","releaseId":"1dc5fb4a-8923-471c-a940-53094cd33b76","status":"running"}}}}"#;
