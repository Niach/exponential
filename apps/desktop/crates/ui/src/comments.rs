...
pub(crate) fn composer_row(
    ...
    h_flex()
        ...
        .gap_2()
        .items_end()
        // EXP-491/492: flex column, not block — see the MentionInput root
        // comment; the percent-through-block hop collapsed the composer to
        // fit-content with a comment row in the column.
        .child(
            div()
                .flex_1()
                .min_w_0()
