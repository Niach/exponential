...
/// 0.92 was dialed in visually over the restored frost (0.88 and 0.90 were
/// tried and read too open — the review landed back on EXP-290's exact
/// value). The mechanism is EXP-290's: the lightly frosted content
