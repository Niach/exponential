...
/// 0.95 was dialed in visually over the restored frost (0.88/0.90/0.92 were
/// tried and all read too open once the REAL blur landed — a working
/// backdrop makes even a small bleed read strongly). The mechanism is
