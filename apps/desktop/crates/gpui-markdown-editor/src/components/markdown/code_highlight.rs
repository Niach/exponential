...
// EXP-261 vendoring: only constructed by the stripped tree-sitter path.
#[allow(dead_code)]
...
// EXP-261 vendoring: the per-language tree-sitter `build_*_config`
// constructors were removed together with the grammar dependencies. The
// code-highlight features are unsupported in this vendored build.
