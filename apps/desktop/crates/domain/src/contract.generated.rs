...
pub const ISSUE_EVENT_TYPE_VALUES: &[&str] = &["status_changed", "assignee_changed", "label_added", "label_removed", "pr_opened", "pr_merged", "board_moved", "created", "priority_changed"];
...
pub const STEER_COMMAND_NAMES: &[&str] = &["compact", "clear", "new", "model", "init", "review"];
pub const STEER_COMMAND_DESCRIPTIONS: &[&str] = &["Compact the conversation context", "Start a fresh conversation (context is discarded)", "Start a fresh conversation (context is discarded)", "Switch the model", "Write CLAUDE.md / AGENTS.md for this repo", "Review the current changes"];
pub const STEER_COMMAND_ARG_HINTS: &[&str] = &["instructions", "", "", "model", "", ""];
pub const STEER_COMMAND_AGENTS: &[&str] = &["claude,codex,pi", "claude", "codex,pi", "claude,pi", "claude,codex", "claude,codex"];
pub const STEER_COMMAND_CONFIRM: &[bool] = &[false, true, true, false, false, false];
