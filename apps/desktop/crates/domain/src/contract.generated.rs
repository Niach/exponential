...
pub const CODING_SESSION_OUTCOME_VALUES: &[&str] = &["done", "blocked", "no_changes"];
...
pub const CODING_SESSION_OUTCOME_DONE: &str = "done";
pub const CODING_SESSION_OUTCOME_BLOCKED: &str = "blocked";
pub const CODING_SESSION_OUTCOME_NO_CHANGES: &str = "no_changes";
